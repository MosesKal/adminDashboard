export const MENUITEMS = [
  ...
  },
  {
    ...
    Items: [
      ...
      },
      {
        ...
        icon: (
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-geo side-menu__icon"
            viewBox="0 0 16 16"
          >
            <path
              fill-rule="evenodd"
      ...
      },
      {
        ...
        icon: (
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-chat-right-dots-fill side-menu__icon"
            viewBox="0 0 16 16"
          >
      ...
      {
        path: `/components/apps/challengs`,
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
            fill="currentColor"
            className="bi bi-flag-fill side-menu__icon"
            viewBox="0 0 16 16"
          >
      ...
      },
      {
        ...
        icon: (
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-telephone-outbound-fill side-menu__icon"
            viewBox="0 0 16 16"
          >
            <path
              fill-rule="evenodd"
      ...
      },
      {
        ...
        icon: (
          <svg
            ...
            height="16"
            fill="currentColor"
            className="bi bi-check-circle-fill side-menu__icon"
            viewBox="0 0 16 16"
          >
      ...
      {
        path: `/components/apps/organisations`,
        icon: (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
            fill="currentColor"
            className="bi bi-building side-menu__icon"
            viewBox="0 0 16 16"
          >
