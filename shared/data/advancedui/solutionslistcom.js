...
const Solutionslistcom = () => {
    ...
    const handleSelectChangeStatus = (selectedOption) => {
        ...
        setFilters({
            ...filters, statusFilter: String(selectedOption?.label) || "all",
        });
    };
    ...
    return (<div>
        <Row className="row-sm col-12">
            {isAdmin ? (<div className="panel panel-primary tabs-style-2 col-12">
                                ...
                                >
                                    <Col lg={12} className="w-full">
                                        <Card className="custom-card">
                                            <Card.Body>
                                                {isLoadingSolution ? (<div className="text-center">
            ...
            </div>) : (<Col lg={12} className="w-full">
                <Card className="custom-card">
                    <Card.Body>
                        {isLoadingSolution ? (<div className="text-center">
                            <Spinner animation="border" variant="primary"/>
