...
import {chartToImage, generateStatistics, styles} from "@/pages/services/services.reporting";
import tinycolor from "tinycolor2";
import {Page, Text, View} from "@react-pdf/renderer";

const StatCuration = ({solutions, thematiqueData}) => {

    const statistics = generateStatistics({solutions});
