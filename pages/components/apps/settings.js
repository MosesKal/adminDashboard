...
const Settingscom = dynamic(
  () => import("@/shared/data/advancedui/settingscom"),
  { ssr: false }
);
...
const Settings = () => {
  ...
  const handleCreateRole = async (e) => {
    ...
    try {
      ...
      await axios.post("/roles", JSON.stringify(payload));
        ...
        <div className="left-content mt-2">
          ...
          <Modal show={show} onHide={handleClose}>
            <Modal.Header className="modal-header">
              <h6 className="modal-title">{"Ajouter Rôle"}</h6>
              <Button
                variant=""
                className="btn-close"
                type="button"
